  ...
  return (
    <div>
      <div className="review bg-gray-200">
        <img src={Profile1} alt="" className="h-auto w-full opacity-100" />      
      </div>

      <div className="absolute left-80 top-0   h-full w-full flex  items-center">            
        <h1 className="text-4xl font-bold mb-3">Welcome to Flavor Feed</h1>   
        ...
        <div className="f1">
                {/* <section className="bg-gray-800 dark:bg-gray-900 opacity-75"> */}
                    <div className="absolute top-0  flex-col items-center justify-center px-32 py-8  md:h-screen lg:py-0">
                        <br />
                        <br />
                        <br />
                        <br />
                        ...
                        <div
                            ...
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form className="space-y-4 md:space-y-6" autocomplete="off"
                                    ...
                                    <div>
                                        <label for="percentage"
                                            className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contact Number</label>
                                        <input type="text" name="percentage" id="percentage"
                                            className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Phone"
                                            onChange={(e)=>(e.target.value)}
